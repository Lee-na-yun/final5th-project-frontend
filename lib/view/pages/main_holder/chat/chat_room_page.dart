...
import 'package:riverpod_firestore_steam1/view/pages/main_holder/chat/components/my_chat.dart';
import 'package:riverpod_firestore_steam1/view/pages/main_holder/chat/components/other_chat.dart';
...
class ChatRoomPage extends StatefulWidget {
  const ChatRoomPage({Key? key, this.user, this.chatroom, this.userInfo})
      : super(key: key);
  final chatroom;
  final user;
  final userInfo;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: PreferredSize(
            ...
            child: LineAppBar(widget.chatroom['name'], null)),
        body: Container(
          child: Scaffold(
            body: Column(
              children: [
