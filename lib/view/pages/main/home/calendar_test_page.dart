...
import 'package:riverpod_firestore_steam1/view/pages/main/home/widget/calendar_v3.dart';
      ...
      body: Container(
        child: Column(
          children: [
            ...
            CalendarV2(),
            Expanded(
              child: _buildCustomScrollView(context, bottomInset),
            ),
          ],
        ),
      ),
          ...
          child: Column(
            ...
            children: <Widget>[
              Expanded(
                child: Container(
                  height:
                      MediaQuery.of(context).size.height / 2.5 + bottomInset,
